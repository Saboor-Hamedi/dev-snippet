...
## 6. Stability & Error Prevention Guide
...
* **Header Metrics**: H1/H2 attributes must use `rem` (Root EM) and not `em`. `em` is relative to the *editor* font size, which varies by theme.
...
## 8. Web Worker & Performance Offloading
...
## 10. Document Splitting & Sequential Linking
...
*Technical reference for DevSnippet. Last updated: January 2, 2026. v1.3.3*
