  ...
  return (tree) => {
    visit(tree, 'code', (node, index, parent) => {
      if (node.lang === 'mermaid') {
        ...
        const html = `
          <div class="mermaid-diagram-wrapper" style="display: flex !important; flex-direction: column !important; width: 100% !important; background: var(--color-bg-secondary) !important; border: 1px solid var(--color-border) !important; border-radius: 12px !important; margin: 2rem 0 !important; box-sizing: border-box !important; box-shadow: 0 10px 30px -10px rgba(0,0,0,0.5) !important;">
