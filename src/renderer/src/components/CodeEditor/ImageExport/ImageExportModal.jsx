    ...
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-5xl h-[85vh] bg-[var(--bg-secondary)] rounded-2xl shadow-2xl border border-[var(--color-border)] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="flex-1 flex min-h-0">
          {/* Main Preview Area */}
          <div className="flex-1 overflow-auto p-8 bg-slate-50/50 dark:bg-slate-900/50 flex items-center justify-center checkered-bg">
            {/* The Capture Node */}
            <div
              ref={exportRef}
              className={`relative transition-all duration-300 ${padding.value} ${activeGradient.class} flex items-center justify-center min-w-[500px]`}
              style={{ minHeight: '300px' }}
            >
              {/* The Window Container */}
              <div className="w-full bg-[#1e1e1e] rounded-xl shadow-2xl overflow-hidden border border-white/10">
                {/* Window Controls */}
                <div className="flex items-center gap-2 px-4 py-3 bg-[#252526] border-b border-white/5">
                  ...
                  <div className="ml-4 text-xs font-mono text-slate-500 opacity-60">
                    {snippet.title}
                  </div>
                </div>
                ...
                <div className="p-0">
                  <SyntaxHighlighter
                    ...
                    wrapLines={true}
                    wrapLongLines={true} // Ensure it doesn't break layout width too much
                  >
                    {snippet.code || ''}
                  </SyntaxHighlighter>
                </div>
