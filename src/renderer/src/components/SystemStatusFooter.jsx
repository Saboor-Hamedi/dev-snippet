...
const SystemStatusFooter = ({ snippets = [] }) => {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 text-xs" style={{ color: 'var(--statusbar-text)' }}>
      ...
      <div className="flex items-center gap-2 text-xs" style={{ color: 'var(--statusbar-text)' }}>
