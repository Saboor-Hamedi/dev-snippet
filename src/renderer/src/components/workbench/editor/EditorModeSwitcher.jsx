    ...
    >
      ...
      <div className="flex items-center gap-[3px]">
        ...
        {onPing && (
          ...
          >
            <svg viewBox="0 0 24 24" width="14" height="14" fill={initialSnippet?.is_pinned ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2">
        ...
        {[
          {
            ...
            label: 'Source',
            icon: (active) => (
              <svg viewBox="0 0 24 24" width="14" height="14" fill={active ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2">
                <path d="M8 6L2 12l6 6h2.5L4.5 12 10.5 6H8zM16 6l6 6-6 6h-2.5l6-6-6-6h2.5z" fill="currentColor" stroke="none" style={{ display: active ? 'block' : 'none' }} />
                {!active && (
                  <>
